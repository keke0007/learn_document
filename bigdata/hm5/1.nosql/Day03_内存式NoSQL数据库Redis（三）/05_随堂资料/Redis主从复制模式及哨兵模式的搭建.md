  ...
  - **启动测试**
    ...
    - 读写测试
      ...
      - 主节点
        ...
        ![image-20210522113220871](Redis主从复制模式及哨兵模式的搭建.assets/image-20210522113220871.png)

        

        ![image-20210522112914552](Redis主从复制模式及哨兵模式的搭建.assets/image-20210522112914552.png)

      - 从

        ![image-20210522113242706](Redis主从复制模式及哨兵模式的搭建.assets/image-20210522113242706.png)

        

        ![image-20210522113001513](Redis主从复制模式及哨兵模式的搭建.assets/image-20210522113001513.png)
...
- **实施**
  ...
  - **测试**
    ...
    - 连接Redis
      ...
      ![image-20210522120807619](Redis主从复制模式及哨兵模式的搭建.assets/image-20210522120807619.png)
    ...
    - kill当前的Master，观察哨兵信息
      ...
      ![image-20210522120846758](Redis主从复制模式及哨兵模式的搭建.assets/image-20210522120846758.png)
