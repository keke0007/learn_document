...
![image-20220116202912606](day01_python基础.assets/image-20220116202912606.png)
...
![image-20220116205034207](day01_python基础.assets/image-20220116205034207.png)

​		目前基于Python的应用场景非常的广泛, 包括web开发, 测试, 爬虫, 机器学习, 数据分析等, 由于是在最近几年python在大数据中应用也是非常的广泛, 比如在 spark中, pyspark库的每月下载量超过500w次

![image-20220116210230486](day01_python基础.assets/image-20220116210230486.png)
...
* 1- 下载python解析器
  ...
  ![image-20220116210459682](day01_python基础.assets/image-20220116210459682.png)

  * windows为例

  ![image-20220116210606658](day01_python基础.assets/image-20220116210606658.png)

  * mac版本

  ![image-20220116210721927](day01_python基础.assets/image-20220116210721927.png)
...
* 2- 安装解析器:
  ...
  * windows:
  ...
  ![image-20220116211702475](day01_python基础.assets/image-20220116211702475.png)

  ![image-20220116211728130](day01_python基础.assets/image-20220116211728130.png)

  ![image-20220116211835592](day01_python基础.assets/image-20220116211835592-16423391245651.png)

  ![image-20220116211913698](day01_python基础.assets/image-20220116211913698.png)

  ![image-20220116211945668](day01_python基础.assets/image-20220116211945668.png)

  ​	打开CMD, 进行校验:

  ​	![image-20220116212031756](day01_python基础.assets/image-20220116212031756.png)

  

  * mac系统:

  ![image-20220116211021480](day01_python基础.assets/image-20220116211021480.png)

  ![image-20220116211036794](day01_python基础.assets/image-20220116211036794.png)

  ![image-20220116211059816](day01_python基础.assets/image-20220116211059816.png)

  ![image-20220116211112618](day01_python基础.assets/image-20220116211112618.png)

  ![image-20220116211127109](day01_python基础.assets/image-20220116211127109.png)

  ![image-20220116211137097](day01_python基础.assets/image-20220116211137097.png)
...
![image-20220116212207902](day01_python基础.assets/image-20220116212207902.png)

![image-20220116212233195](day01_python基础.assets/image-20220116212233195.png)

​	下载专业版本: 请务必选择此版本(跟后续绿化有关系)

![image-20220118200721142](day01_python基础.assets/image-20220118200721142.png)

* 2- 安装pycharm:

![image-20220116212513618](day01_python基础.assets/image-20220116212513618.png)

![image-20220116212522981](day01_python基础.assets/image-20220116212522981.png)

![image-20220116212534439](day01_python基础.assets/image-20220116212534439.png)

![image-20220116212545593](day01_python基础.assets/image-20220116212545593.png)

![image-20220116212554659](day01_python基础.assets/image-20220116212554659.png)

​	双击打开即可: 如果弹出一下界面, 选择即可

![image-20220118201401882](day01_python基础.assets/image-20220118201401882.png)
...
![image-20220118201555376](day01_python基础.assets/image-20220118201555376.png)

此时, 我们就看到以下界面了:

![image-20220118201635065](day01_python基础.assets/image-20220118201635065.png)



提供30天无限续期的绿化操作: 

![image-20220116213207647](day01_python基础.assets/image-20220116213207647.png)

如果弹出以下界面:

![image-20220118201757426](day01_python基础.assets/image-20220118201757426.png)

可以尝试, 先创建一个项目, 然后在重新丢入无限续期的jar包:

丢入后:

![image-20220118201951907](day01_python基础.assets/image-20220118201951907.png)

然后选择重启即可:

![image-20220118202207632](day01_python基础.assets/image-20220118202207632.png)

![image-20220118202247673](day01_python基础.assets/image-20220118202247673.png)
...
![image-20220116213637901](day01_python基础.assets/image-20220116213637901.png)

* 2- 选择 `Location` 表示该项目保存的路径，`Interpreter` 表示使用的Python解释器版本，最后点击`Create` 创建项目

![image-20220118204247292](day01_python基础.assets/image-20220118204247292.png)

或者:  

![image-20220510202529315](day01_python基础.assets/image-20220510202529315.png)

![image-20220510202658329](day01_python基础.assets/image-20220510202658329.png)

![image-20220510202741823](day01_python基础.assets/image-20220510202741823.png)
...
![image-20220118204508266](day01_python基础.assets/image-20220118204508266.png)

![image-20220118204538709](day01_python基础.assets/image-20220118204538709.png)

![image-20220118204725895](day01_python基础.assets/image-20220118204725895.png)

* 3-右击项目 选择new, 在选择python File

![image-20220118204751995](day01_python基础.assets/image-20220118204751995.png)

* 4- 在弹出的对话框中输入的文件名hello_world，直接回车，表示创建一个Python程序的文本文件，文本文件后缀名默认.py

![image-20220116214447925](day01_python基础.assets/image-20220116214447925.png)
...
![image-20220116214718601](day01_python基础.assets/image-20220116214718601.png)

* 6- 运行成功后，Pycharm Console窗口将显示我们的输出结果

![image-20220116214817536](day01_python基础.assets/image-20220116214817536.png)
...
![image-20220116215251685](day01_python基础.assets/image-20220116215251685.png)
...
![image-20220116215657027](day01_python基础.assets/image-20220116215657027.png)
...
![image-20220116220323446](day01_python基础.assets/image-20220116220323446.png)
...
![01-第1天-9](day01_python基础.assets/01-第1天-9.gif)
...
![image-20220510211111422](day01_python基础.assets/image-20220510211111422.png)
...
![image-20220116231643272](day01_python基础.assets/image-20220116231643272.png)
...
![image-20220116230453681](day01_python基础.assets/image-20220116230453681.png)
...
![image-20220116230534340](day01_python基础.assets/image-20220116230534340.png)
...
![image-20220116230719951](day01_python基础.assets/image-20220116230719951.png)
...
* 字符串的下标:
  ...
  * 如有字符串:`name = 'abcdef'`，在内存中的实际存储如下:
  ...
  ![image-20220117235736890](day01_python基础.assets/image-20220117235736890.png)
