...
![image-20220123020412280](pandas课件.assets/image-20220123020412280.png)
...
![image-20220123021121835](pandas课件.assets/image-20220123021121835.png)
...
![image-20220123021824587](pandas课件.assets/image-20220123021824587.png)
...
![image-20220123022204903](pandas课件.assets/image-20220123022204903.png)



## 4. pandas的数据结构

![image-20220123022429098](pandas课件.assets/image-20220123022429098.png)
...
![image-20220123163537467](pandas课件.assets/image-20220123163537467.png)
...
* index_col 参数指定索引
  ...
  * 通过列名指定为索引`index_col=['列名']`
  ...
  ![image-20220123164049964](pandas课件.assets/image-20220123164049964.png)
...
* parse_dates 参数指定列解析为时间日期类型
  ...
  * 通过列下标解析该列为时间日期类型`parse_dates=[列下标]`
  ...
  ![image-20220123164314613](pandas课件.assets/image-20220123164314613.png)
  ...
  * 通过列名解析该列为时间日期类型`parse_dates=[列名]`
  ...
  ![image-20220123164423959](pandas课件.assets/image-20220123164423959.png)
  ...
  * 将df的索引解析为时间日期类型`parse_dates=True`
  ...
  ![image-20220123164514724](pandas课件.assets/image-20220123164514724.png)
...
* encoding 参数 指定编码格式
  ...
  ![image-20220123164735677](pandas课件.assets/image-20220123164735677.png)
...
* sep参数, 指定字段之间的分隔符号
  ...
  ![image-20220123165048778](pandas课件.assets/image-20220123165048778.png)
...
![image-20220125205916505](pandas课件.assets/image-20220125205916505.png)
...
![image-20220123165416808](pandas课件.assets/image-20220123165416808.png)
...
* 此时我们就可以在本地test库的test_pdtosql表中看到写入的数据
  ...
  ![image-20220123165745328](pandas课件.assets/image-20220123165745328.png)
...
* 从数据库中加载数据:
  ...
  * 使用SQL语句获取数据，返回dataframe
  ...
  ![image-20220123165932157](pandas课件.assets/image-20220123165932157.png)



可能出现的问题:

![image-20220125211715019](pandas课件.assets/image-20220125211715019.png)
...
![image-20220123170950953](pandas课件.assets/image-20220123170950953.png)
...
![image-20220123171301624](pandas课件.assets/image-20220123171301624.png)

![image-20220123171341864](pandas课件.assets/image-20220123171341864.png)

![image-20220123171406363](pandas课件.assets/image-20220123171406363.png)
...
![image-20220123171512469](pandas课件.assets/image-20220123171512469.png)
...
![image-20220123175505374](pandas课件.assets/image-20220123175505374.png)
...
![image-20220124002357527](pandas课件.assets/image-20220124002357527.png)

![image-20220124002420378](pandas课件.assets/image-20220124002420378.png)
...
![image-20220124002643359](pandas课件.assets/image-20220124002643359.png)
...
![image-20220124002916191](pandas课件.assets/image-20220124002916191.png)

![image-20220124002939445](pandas课件.assets/image-20220124002939445.png)
...
* 3- 索引下标切片取行
  ...
  * `df[start:stop:step]`:
  ...
  ![image-20220124003930052](pandas课件.assets/image-20220124003930052.png)
...
* 4- 查询函数获取子集: df.query()
  ...
  * 示例:
  ...
  ![image-20220124004422387](pandas课件.assets/image-20220124004422387.png)
  ...
  * 查询中国, 美国  日本 三国 2015年至2019年的数据
  ...
  ![image-20220124004525553](pandas课件.assets/image-20220124004525553.png)
...
* 5- 排序函数
  ...
  * rank函数:
  ...
  ![image-20220124010302102](pandas课件.assets/image-20220124010302102.png)
  ...
  ![image-20220124010717941](pandas课件.assets/image-20220124010717941.png)
...
* 2- 分组后获取各个组内的数据
  ...
  * 2.1 取出每组第一条或最后一条数据
  ...
  ![image-20220124012357765](pandas课件.assets/image-20220124012357765.png)
  ...
  * 2.2 - 按分组依据获取其中一组
  ...
  ![image-20220124012526559](pandas课件.assets/image-20220124012526559.png)
...
* 3- 分组聚合
  ...
  * 格式:分组后对多列分别使用不同的聚合函数
  ...
  ![image-20220124013227222](pandas课件.assets/image-20220124013227222.png)
