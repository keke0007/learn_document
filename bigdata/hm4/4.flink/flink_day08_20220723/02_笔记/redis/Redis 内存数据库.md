...
![1635559951211](assets/1635559951211.png)
...
> Redis 快速入门：**Redis的常见命令和客户端使用**

![1651132383280](assets/1651132383280.png)
...
![1651132402922](assets/1651132402922.png)
...
![img](assets/src=http_%2F%2Fimg3.doubanio.com%2Fview%2Fgroup_topic%2Fl%2Fpublic%2Fp91430070.jpg&refer=http_%2F%2Fimg3.doubanio.jpg)

```ini
Redis数据库：
	1. 内存数据库，将数据放入内存，读写数据非常快
	
	2. key/value 管理数据，存储数据指定key和value，读取数据依据key获取value值
...
![1651135679070](assets/1651135679070.png)



> SQL 数据库与NoSQL 数据库，主要区别如下4个方面：

![1651135816086](assets/1651135816086.png)



![1651136249297](assets/1651136249297.png)





> DB-Engines 数据库排名：http://db-engines.com/en/ranking

![1651135968500](assets/1651135968500.png)
...
### 01-[了解]-初识Redis之认识 Redis

---



![1651135439500](assets/1651135439500.png)
...
在课程【**04_软件及配置**】中可以找到Redis的图形化桌面客户端：
...
## 第二部分：Redis 常见命令【7个小节】

> Redis 内存数据库中常见数据类型及命令：

![1651140610292](assets/1651140610292.png)
...
![1651141000063](assets/1651141000063.png)
...
![1651141146935](assets/1651141146935.png)
...
![1651144451770](assets/1651144451770.png)



> 常用Java客户端：`Jedis、lettuce及Redisson`

![1651144522924](assets/1651144522924.png)





### 11-[掌握]-Jedis 客户端之Jedis 连接
...
public class JedisPoolTest {
	...
	public void open(){
		...
		config.setMaxIdle(8);
		// 1-2. 连接池
		JedisPool jedisPool = new JedisPool(config, "node1.itcast.cn", 6379) ;
		// 1-3. 获取连接
...
> Jedis中实现其他类型操作：**Hash类型、List类型、Set类型、SortedSet类型**
